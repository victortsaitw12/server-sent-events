# SSE 課程 - Step 5：心跳與斷線清理

> 這是 [Server-Sent Events 課程](https://github.com/victortsaitw12/server-sent-events)（.NET 9 + 原生 JavaScript）的第 5 步（最後一步）。
> 回到 [課程總覽](https://github.com/victortsaitw12/server-sent-events/blob/main/README.md) ・ 上一步：[`step-4-broadcast`](https://github.com/victortsaitw12/server-sent-events/tree/step-4-broadcast)
